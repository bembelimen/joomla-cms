...
abstract class WebApplication extends AbstractWebApplication
{
	 ...
	 *              Use \Joomla\CMS\Factory::getContainer()->get($name) instead
     */
     ...
     *
     * @since   1.7.3
     * #deprecated  4.0 will be removed in 5.0
	 *              The session should be injected as a service, use setSession instead.
     */
