...
final class Contact extends CMSPlugin implements SubscriberInterface
{
    ...
    public function onLinkProvidersSetup(LinkProvidersSetupEvent $event): void
    {
        ...
        $event->getDocument()->addScriptOptions('link-providers', [
            'contact' => [
                'title'  => Text::_('PLG_EDITORS-XTD_CONTACT_BUTTON_CONTACT'),
                'icon'   => 'address',
                'src'    => 'index.php?option=com_contact&view=contacts&layout=modal&tmpl=component',
                'select' => 'content',
            ],
        ], true);
    }
    ...
    /**
     * Whether the current user may link to com_contact records.
     *
     * @return  boolean
     *
     * @since   __DEPLOY_VERSION__
    ...
    private function hasAccess(): bool
    {
        ...
        return $user->authorise('core.create', 'com_contact')
